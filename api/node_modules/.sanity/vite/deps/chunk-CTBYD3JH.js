...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources3-OHXFCGDU.js")
});
...
function ReferencePreviewLink(props) {
  ...
  return (0, import_jsx_runtime.jsx)(PreviewCard, { __unstable_focusRing: true, as: Link, "data-as": "a", onClick, radius: 2, children: (0, import_jsx_runtime.jsx)(
    PaneItemPreview,
    {
      ...
      layout: "compact",
      presence: (documentPresence == null ? void 0 : documentPresence.length) > 0 ? documentPresence : EMPTY_ARRAY$1,
      schemaType: type,
      value
    }
  ) });
...
function useReferringDocuments(documentId) {
  ...
  ).sort(), [crossDatasetReferences == null ? void 0 : crossDatasetReferences.references]), hasUnknownDatasetNames = (0, import_react.useMemo)(() => !!(crossDatasetReferences == null ? void 0 : crossDatasetReferences.references.some(
...
function ConfirmDeleteDialog({
  ...
  return (0, import_jsx_runtime.jsx)(
    Dialog2,
    {
      ...
      children: (0, import_jsx_runtime.jsx)(DialogBody$1, { children: crossDatasetReferences && internalReferences && !isLoading ? (0, import_jsx_runtime.jsx)(
    ...
    MenuButton,
    {
      ...
      menu: (0, import_jsx_runtime.jsx)(Menu, { children: node.children.map((child, idx) => {
        ...
        return (0, import_jsx_runtime.jsx)(
          ...
          {
            disabled: !!node.disabled,
            isAfterGroup: ((_a = node.children[idx - 1]) == null ? void 0 : _a.type) === "group",
            node: child
          },
          child.key
        );
...
function PaneLayout(props) {
  var _a;
  const { children, minWidth, onCollapse, onExpand, ...restProps } = props, controller = (0, import_react.useMemo)(() => createPaneLayoutController(), []), [rootElement, setRootElement] = (0, import_react.useState)(null), width = ((_a = useElementRect(rootElement)) == null ? void 0 : _a.width) || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth, [state2, setState] = (0, import_react.useState)({
...
function PaneHeaderCreateButton({ templateItems }) {
  ...
  if (templateItems.length === 1) {
    const firstItem = templateItems[0], disabled = !((_a = permissionsById[firstItem.id]) == null ? void 0 : _a.granted), intent = getIntent(schema, templates, firstItem);
  ...
  return (0, import_jsx_runtime.jsx)(
    MenuButton,
    {
      ...
      menu: (0, import_jsx_runtime.jsx)(Menu, { children: templateItems.map((item, itemIndex) => {
        var _a2;
        const disabled = !((_a2 = permissionsById[item.id]) == null ? void 0 : _a2.granted), intent = getIntent(schema, templates, item), template = templates.find((i) => i.id === item.templateId);
        if (!template || !intent)
          return null;
...
function useDocumentTitle() {
  const { connectionState, schemaType, title, editState } = useDocumentPane(), documentValue = (editState == null ? void 0 : editState.draft) || (editState == null ? void 0 : editState.published), subscribed = !!documentValue, { error, value } = useDocumentPreview({
    enabled: subscribed,
    schemaType,
    value: documentValue
  });
  return connectionState === "connecting" && !subscribed ? { error: void 0, title: void 0 } : title ? { error: void 0, title } : documentValue ? error ? { error: `Error: ${error.message}`, title: void 0 } : { error: void 0, title: value == null ? void 0 : value.title } : { error: void 0, title: `New ${(schemaType == null ? void 0 : schemaType.title) || (schemaType == null ? void 0 : schemaType.name)}` };
}
var IGNORE_OPS = ["patch", "commit"];
var DocumentOperationResults = (0, import_react.memo)(function() {
  const { push: pushToast } = useToast(), { documentId, documentType, value: documentPaneValue } = useDocumentPane(), documentTitleInfo = useDocumentTitle(), titleError = documentTitleInfo.error, event = useDocumentOperationEvent(documentId, documentType), prevEvent = (0, import_react.useRef)(event), paneRouter = usePaneRouter(), { t } = useTranslation2(structureLocaleNamespace), documentTitleBase = (0, import_react.useMemo)(() => !documentTitleInfo.title && !titleError && !IGNORE_OPS.includes(event == null ? void 0 : event.op) && typeof documentPaneValue.title == "string" && (event == null ? void 0 : event.type) === "success" ? documentPaneValue.title : documentTitleInfo.title, [documentTitleInfo.title, titleError, event, documentPaneValue.title]) || t("panes.document-operation-results.operation-undefined-title"), documentTitle = documentTitleBase.length > 25 ? `${documentTitleBase.slice(0, 25)}...` : documentTitleBase;
  return (0, import_react.useEffect)(() => {
...
function useStructureToolSetting(namespace, key, defaultValue) {
  const keyValueStore = useKeyValueStore(), keyValueStoreKey = [STRUCTURE_TOOL_NAMESPACE, namespace, key].filter(Boolean).join("."), value$ = (0, import_react.useMemo)(() => keyValueStore.getKey(keyValueStoreKey), [keyValueStore, keyValueStoreKey]), value = useObservable(value$, defaultValue), set = (0, import_react.useCallback)(
    (newValue) => {
      newValue !== value && keyValueStore.setKey(keyValueStoreKey, newValue);
    },
...
var JSONInspectorWrapper = dt.div(({ theme }) => {
...
function Banner(props) {
  ...
  return (0, import_jsx_runtime.jsx)(Card, { borderBottom: true, paddingX: 4, paddingY: 2, tone, ...rest, children: (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 3, children: [
    ...
    action && (0, import_jsx_runtime.jsx)(Button2, { ...action, mode: action.mode || "ghost", tone: action.tone || "default" })
  ] }) });
}
...
function RequestPermissionDialog({
  ...
  const { t } = useTranslation2(structureLocaleNamespace), telemtry = useTelemetry(), dialogId = `request-permissions-${(0, import_react.useId)()}`, projectId = useProjectId(), client = useClient({ apiVersion: "2024-09-26" }), toast = useToast(), zOffset = useZIndex(), [isSubmitting, setIsSubmitting] = (0, import_react.useState)(false), [note, setNote] = (0, import_react.useState)(""), [msgError, setMsgError] = (0, import_react.useState)(), [hasTooManyRequests, setHasTooManyRequests] = (0, import_react.useState)(false), [hasBeenDenied, setHasBeenDenied] = (0, import_react.useState)(false), requestedRole$ = (0, import_react.useMemo)(() => {
    const adminRole = "administrator";
    return !projectId || !client ? of(adminRole) : client.observable.request({ url: `/projects/${projectId}/roles` }).pipe(
      map((roles) => roles.filter((role) => role == null ? void 0 : role.appliesToUsers).find((role) => role.name === "editor") ? "editor" : adminRole),
      startWith(adminRole),
      catchError(() => of(adminRole))
    );
  }, [projectId, client]), requestedRole = useObservable(requestedRole$), onSubmit = () => {
    setIsSubmitting(true), client.request({
      url: `/access/project/${projectId}/requests`,
      method: "post",
      body: { note, requestUrl: window == null ? void 0 : window.location.href, requestedRole, type: "role" }
    }).then((request) => {
  ...
  return (0, import_jsx_runtime.jsx)(DialogProvider, { position: "fixed", zOffset: zOffset.fullscreen, children: (0, import_jsx_runtime.jsx)(
    Dialog2,
    {
      width: 1,
      id: dialogId,
      ...
      children: (0, import_jsx_runtime.jsx)(DialogBody, { children: (0, import_jsx_runtime.jsxs)(Stack, { space: 4, children: [
        (0, import_jsx_runtime.jsx)(Text, { children: t("request-permission-dialog.description.text") }),
        hasTooManyRequests || hasBeenDenied ? (0, import_jsx_runtime.jsx)(Card, { tone: "caution", padding: 3, radius: 2, shadow: 1, children: (0, import_jsx_runtime.jsxs)(Text, { size: 1, children: [
...
var LOADING_STATE = { loading: true, error: false, status: void 0 };
var EMPTY_STATE = { loading: false, error: false, status: "none" };
var DECLINED_STATE = { loading: false, error: false, status: "declined" };
var PENDING_STATE = { loading: false, error: false, status: "pending" };
var EXPIRED_STATE = { loading: false, error: false, status: "expired" };
var useRoleRequestsStatus = () => {
  const client = useClient({ apiVersion: "2024-07-01" }), projectId = useProjectId(), checkRoleRequests$ = (0, import_react.useMemo)(() => !client || !projectId ? of(EMPTY_STATE) : checkRoleRequests(client, projectId), [client, projectId]), { loading, error, status } = useObservable(checkRoleRequests$, LOADING_STATE);
...
function checkRoleRequests(client, projectId) {
  return client.observable.request({
    ...
    map((requests) => {
      ...
      ), declinedRequest = projectRequests.find((request) => request.status === "declined");
      return declinedRequest && isAfter(addWeeks(new Date(declinedRequest.createdAt), 2), /* @__PURE__ */ new Date()) ? DECLINED_STATE : projectRequests.find(
        (request) => request.status === "pending" && isAfter(addWeeks(new Date(request.createdAt), 2), /* @__PURE__ */ new Date())
      ) ? PENDING_STATE : projectRequests.find(
        (request) => request.status === "pending" && isBefore(addWeeks(new Date(request.createdAt), 2), /* @__PURE__ */ new Date())
      ) ? EXPIRED_STATE : EMPTY_STATE;
    }),
    catchError((err) => (console.error("Failed to fetch access requests", err), of({ loading: false, error: true, status: void 0 }))),
...
function InsufficientPermissionBanner({
  ...
  } = useRoleRequestsStatus(), [requestSent, setRequestSent] = (0, import_react.useState)(false), requestPending = (0, import_react.useMemo)(
    () => roleRequestStatus === "pending" || roleRequestStatus === "declined" || requestSent,
    [roleRequestStatus, requestSent]
  ), currentUserRoles = (currentUser == null ? void 0 : currentUser.roles) || [], isOnlyViewer = currentUserRoles.length === 1 && currentUserRoles[0].name === "viewer", [showRequestPermissionDialog, setShowRequestPermissionDialog] = (0, import_react.useState)(false), listFormat = useListFormat({ style: "short" }), { t } = useTranslation2(structureLocaleNamespace), telemetry = useTelemetry(), roleTitles = currentUserRoles.map((role) => role.title), roles = listFormat.formatToParts(roleTitles).map(
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)(
      Banner,
      {
        ...
        action: isOnlyViewer && roleRequestStatus && !requestStatusError && !requestStatusLoading ? {
    ...
    showRequestPermissionDialog && (0, import_jsx_runtime.jsx)(
...
var ReferenceChangedBanner = (0, import_react.memo)(() => {
  ...
  const documentPreviewStore = useDocumentPreviewStore(), { params, groupIndex, routerPanesState, replaceCurrent, BackLink: BackLink2 } = usePaneRouter(), routerReferenceId = (_a = routerPanesState[groupIndex]) == null ? void 0 : _a[0].id, parentSibling = (_b = routerPanesState[groupIndex - 1]) == null ? void 0 : _b[0], parentId = parentSibling == null ? void 0 : parentSibling.id, hasHistoryOpen = !!((_c = parentSibling == null ? void 0 : parentSibling.params) == null ? void 0 : _c.rev), parentRefPath = (0, import_react.useMemo)(() => (params == null ? void 0 : params.parentRefPath) && fromString(params.parentRefPath) || null, [params == null ? void 0 : params.parentRefPath]), { t } = useTranslation2(structureLocaleNamespace), referenceInfoObservable = (0, import_react.useMemo)(() => {
  ...
  return (
    ...
    ((_f = referenceInfo.result) == null ? void 0 : _f.refValue) === routerReferenceId ? null : (0, import_jsx_runtime.jsx)(
      Banner,
      {
        action: ((_g = referenceInfo.result) == null ? void 0 : _g.refValue) ? {
        ...
        content: (0, import_jsx_runtime.jsx)(Text, { size: 1, weight: "medium", children: ((_h = referenceInfo.result) == null ? void 0 : _h.refValue) ? t("banners.reference-changed-banner.reason-changed.text") : t("banners.reference-changed-banner.reason-removed.text") }),
...
function DraftLiveEditBanner({
  displayed,
  documentId,
  schemaType
}) {
  const { t } = useTranslation2(structureLocaleNamespace), [isPublishing, setPublishing] = (0, import_react.useState)(false), [isDiscarding, setDiscarding] = (0, import_react.useState)(false), telemetry = useTelemetry(), { publish, discardChanges } = useDocumentOperation(documentId, (displayed == null ? void 0 : displayed._type) || ""), handlePublish = (0, import_react.useCallback)(() => {
    publish.execute(), setPublishing(true), telemetry.log(ResolvedLiveEdit, { liveEditResolveType: "publish" });
  }, [publish, telemetry]), handleDiscard = (0, import_react.useCallback)(() => {
    discardChanges.execute(), setDiscarding(true), telemetry.log(ResolvedLiveEdit, { liveEditResolveType: "discard" });
  }, [discardChanges, telemetry]);
  return (0, import_react.useEffect)(() => () => {
    setPublishing(false), setDiscarding(false);
  }), displayed && displayed._id && !isDraftId(displayed._id) ? null : (0, import_jsx_runtime.jsx)(
    Banner,
    {
      content: (0, import_jsx_runtime.jsxs)(Flex, { align: "center", justify: "space-between", gap: 1, children: [
        (0, import_jsx_runtime.jsx)(Text, { size: 1, weight: "medium", children: (0, import_jsx_runtime.jsx)(
          Translate,
          {
            t,
...
var FormHeader = ({ documentId, schemaType, title }) => {
  ...
  return schemaType.__experimental_formPreviewTitle === false ? null : (0, import_jsx_runtime.jsxs)(TitleContainer, { marginBottom: 6, space: 4, children: [
    !isSingleton && (0, import_jsx_runtime.jsx)(Text, { muted: true, size: 1, children: schemaType.title ?? schemaType.name }),
    (0, import_jsx_runtime.jsx)(Heading, { as: "h2", "data-heading": true, muted: !title, "data-testid": "document-panel-document-title", children: title ?? t("document-view.form-view.form-title-fallback") })
  ] });
};
var LONG_ENOUGH_BUT_NOT_TOO_LONG = 1e3 * 60 * 60 * 24 * 24;
function useConditionalToast(params) {
  const toast = useToast();
  (0, import_react.useEffect)(() => (params.enabled && toast.push({ ...params, duration: LONG_ENOUGH_BUT_NOT_TOO_LONG }), () => {
...
var FormView = (0, import_react.forwardRef)(function(props, ref) {
  ...
  const { hidden, margins } = props, {
    ...
    openPath
  } = useDocumentPane(), documentStore = useDocumentStore(), presence = useDocumentPresence(documentId), { title } = useDocumentTitle(), patchChannel = (0, import_react.useMemo)(() => createPatchChannel(), []), isLocked = (_a = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _a.enabled, { t } = useTranslation2(structureLocaleNamespace), conditionalToastParams = (0, import_react.useMemo)(
    () => ({
      id: "sync-lock",
      status: "warning",
      enabled: isLocked,
      ...
      children: (0, import_jsx_runtime.jsx)(PresenceOverlay, { margins, children: (0, import_jsx_runtime.jsx)(Box, { as: "form", onSubmit: preventDefault, ref: setRef, children: connectionState === "connecting" && !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published) ? (0, import_jsx_runtime.jsx)(Delay, { ms: 300, children: (0, import_jsx_runtime.jsxs)(Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: [
        ...
        (0, import_jsx_runtime.jsx)(
          FormBuilder,
          {
            ...
            openPath,
            presence,
            readOnly: connectionState === "reconnecting" || formState.readOnly || !(editState == null ? void 0 : editState.ready),
...
var Scroller$1 = dt(ScrollContainer)(({ $disabled }) => $disabled ? { height: "100%" } : lt`
    height: 100%;
    overflow: auto;
    position: relative;
...
var DocumentPanel = function(props) {
  ...
  ), isLiveEdit = isLiveEditEnabled(schemaType);
  (0, import_react.useEffect)(() => {
      ...
      PortalProvider,
      {
        ...
        children: (0, import_jsx_runtime.jsx)(BoundaryElementProvider, { element: documentScrollElement, children: (0, import_jsx_runtime.jsxs)(
          VirtualizerScrollInstanceProvider,
          {
            ...
            children: [
              activeView.type === "form" && isLiveEdit && ready && (0, import_jsx_runtime.jsx)(
                DraftLiveEditBanner,
                {
                  displayed,
                  documentId,
...
function ConfirmDialogContent(props) {
  const { dialog } = props, {
    ...
    onConfirm,
    tone
  } = dialog, { t } = useTranslation2(structureLocaleNamespace), { isTopLayer } = useLayer(), ref = (0, import_react.useRef)(null), handleGlobalKeyDown = (0, import_react.useCallback)(
    (event) => {
      event.key === "Escape" && isTopLayer && onCancel();
    },
    [isTopLayer, onCancel]
  );
  return useGlobalKeyDown(handleGlobalKeyDown), useClickOutsideEvent(isTopLayer && onCancel, () => [ref.current]), (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", ref, style: { minWidth: 304, maxWidth: 400 }, children: [
...
function PopoverDialogContent(props) {
  const { dialog } = props, { content, onClose } = dialog, { isTopLayer } = useLayer(), ref = (0, import_react.useRef)(null), handleGlobalKeyDown = (0, import_react.useCallback)(
    (event) => {
      event.key === "Escape" && isTopLayer && onClose();
    },
    [isTopLayer, onClose]
  );
  return useGlobalKeyDown(handleGlobalKeyDown), useClickOutsideEvent(isTopLayer && onClose, () => [ref.current]), (0, import_jsx_runtime.jsx)("div", { ref, children: content });
}
...
var ActionDialogWrapper = (0, import_react.memo)(function({
  actionStates,
  children,
  referenceElement
}) {
  const [actionIndex, setActionIndex] = (0, import_react.useState)(-1), currentAction = (0, import_react.useMemo)(() => actionStates[actionIndex], [actionIndex, actionStates]), handleAction = (0, import_react.useCallback)((idx) => {
    setActionIndex(idx);
  }, []), result = (0, import_react.useMemo)(() => children({ handleAction }), [children, handleAction]);
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
...
function ActionMenuButton(props) {
  const { actionStates, disabled } = props, idPrefix = (0, import_react.useId)(), [referenceElement, setReferenceElement] = (0, import_react.useState)(null), popoverProps = (0, import_react.useMemo)(
    ...
    []
  ), { t } = useTranslation2(structureLocaleNamespace), renderActionDialog = (0, import_react.useCallback)(
    ({ handleAction }) => (0, import_jsx_runtime.jsx)(
      MenuButton,
      {
  ...
  return (0, import_jsx_runtime.jsx)(ActionDialogWrapper, { actionStates, referenceElement, children: renderActionDialog });
}
...
var DeleteAction = ({ id, type, draft, onComplete }) => {
  ...
  return (0, import_react.useMemo)(() => !isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted) ? {
    tone: "critical",
    icon: TrashIcon,
    disabled: true,
...
var DiscardChangesAction = ({
  ...
  return (0, import_react.useMemo)(() => !published || liveEdit ? null : !isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted) ? {
    tone: "critical",
    icon: ResetIcon,
    disabled: true,
...
var HistoryRestoreAction = ({ id, type, revision, onComplete }) => {
  ...
  return (0, import_react.useMemo)(() => isRevisionLatest ? null : {
...
var PublishAction = (props) => {
  ...
  return (0, import_react.useMemo)(() => {
    ...
    const disabled = !!(publishScheduled || ((_a2 = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _a2.enabled) || publishState === "publishing" || publishState === "published" || hasValidationErrors || publish.disabled);
    return {
...
var DocumentStatusBarActions = (0, import_react.memo)(function() {
  const { actions: allActions, connectionState, documentId, editState } = useDocumentPane(), actions = (0, import_react.useMemo)(
    ...
    [allActions]
  ), renderDocumentStatusBarActions = (0, import_react.useCallback)(
    ({ states }) => (0, import_jsx_runtime.jsx)(
...
var Root$1 = dt(Button)(({ $selected, $disabled }) => lt`
    position: relative;
    width: 100%;
...
var Timeline = ({
  ...
  const [mounted, setMounted] = (0, import_react.useState)(false), { t } = useTranslation2("studio"), filteredChunks = (0, import_react.useMemo)(() => chunks.filter((c) => disabledBeforeFirstChunk && firstChunk ? c.index < firstChunk.index : true), [chunks, disabledBeforeFirstChunk, firstChunk]), selectedIndex = (0, import_react.useMemo)(
    () => (lastChunk == null ? void 0 : lastChunk.id) ? filteredChunks.findIndex((c) => c.id === lastChunk.id) : -1,
...
function TimelineMenu({ chunk, mode, placement }) {
  ...
  }, [setTimelineMode]), handleGlobalKeyDown = (0, import_react.useCallback)(
    (event) => {
...
function DocumentHeaderTabs() {
  ...
  return (0, import_jsx_runtime.jsx)(TabList, { space: 1, children: views2.map((view, index) => (0, import_jsx_runtime.jsx)(
    DocumentHeaderTab,
    {
      icon: view.icon,
...
function DocumentHeaderTab(props) {
  const { icon, id, isActive, label, tabPanelId, viewId, ...rest } = props, { ready, editState } = useDocumentPane(), { setView } = usePaneRouter(), handleClick = (0, import_react.useCallback)(() => setView(viewId), [setView, viewId]);
  return (0, import_jsx_runtime.jsx)(
    Tab,
    {
      ...rest,
      "aria-controls": tabPanelId,
      disabled: !ready && !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published),
      icon,
      id,
      label,
      onClick: handleClick,
  ...
  (0, import_react.forwardRef)(function(_props, ref) {
    ...
    return (0, import_jsx_runtime.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime.jsx)(
      PaneHeader$1,
      {
        border: true,
        ref,
        loading: connectionState === "connecting" && !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published),
...
var DocumentPanelHeaderActionDialogDeferred = (0, import_react.memo)(
  function(props) {
    const { setReferenceElement, referenceElement, contextMenuNodes } = props, states = (0, import_react.useDeferredValue)(props.states);
    return (0, import_jsx_runtime.jsx)(
...
var DocumentPanelHeaderActionDialog = (0, import_react.memo)(function(props) {
  const { states, setReferenceElement, contextMenuNodes, referenceElement } = props, renderActionDialog = (0, import_react.useCallback)(
    ({ handleAction }) => (0, import_jsx_runtime.jsx)("div", { ref: setReferenceElement, children: (0, import_jsx_runtime.jsx)(
  ...
  return (0, import_jsx_runtime.jsx)(ActionDialogWrapper, { actionStates: states, referenceElement, children: renderActionDialog });
});
...
var DocumentBadgesInner = (0, import_react.memo)(function({ states }) {
...
var DocumentBadgesDeferred = (0, import_react.memo)(function(props) {
  const states = (0, import_react.useDeferredValue)(props.states);
  return (0, import_jsx_runtime.jsx)(DocumentBadgesInner, { states });
});
function DocumentBadges() {
  const { badges, editState } = useDocumentPane(), renderDocumentBadges = (0, import_react.useCallback)(({ states }) => (0, import_jsx_runtime.jsx)(DocumentBadgesDeferred, { states }), []);
  return !editState || !badges ? null : (0, import_jsx_runtime.jsx)(RenderBadgeCollectionState, { badges, badgeProps: editState, children: renderDocumentBadges });
}
...
var DocumentStatusPulse = (props) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, { align: "center", gap: 2, "data-testid": "pane-footer-document-status-pulse", children: [
...
var DocumentActionShortcuts = (0, import_react.memo)(
  (props) => {
    const { actionsBoxElement, as = "div", children, ...rest } = props, { actions, editState } = useDocumentPane(), [activeIndex, setActiveIndex] = (0, import_react.useState)(-1), onActionStart = (0, import_react.useCallback)((idx) => {
      ...
      [editState]
    ), renderDocumentActionShortcuts = (0, import_react.useCallback)(
      ({ states }) => (0, import_jsx_runtime.jsx)(
    ...
    return !actionProps || !actions ? null : (0, import_jsx_runtime.jsx)(RenderActionCollectionState, { actionProps, actions, children: renderDocumentActionShortcuts });
  }
);
...
function DocumentLayout() {
  ...
  return schemaType ? (0, import_jsx_runtime.jsxs)(GetFormValueProvider, { value, children: [
    ...
    (0, import_jsx_runtime.jsx)(FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY, children: (0, import_jsx_runtime.jsxs)(
...
var DocumentPaneProvider = (0, import_react.memo)((props) => {
  ...
  const { children, index, pane: pane2, paneKey, onFocusPath } = props, schema = useSchema(), templates = useTemplates(), { setDocumentMeta } = useCopyPaste(), {
    ...
    () => params.path ? fromString(params.path) : EMPTY_ARRAY$y
  ), focusPathRef = (0, import_react.useRef)([]), activeViewId = params.view || views2[0] && views2[0].id || null, [timelineMode, setTimelineMode] = (0, import_react.useState)("closed"), [timelineError, setTimelineError] = (0, import_react.useState)(null), timelineStore = useTimelineStore({
    documentId,
    documentType,
    onError: setTimelineError,
    rev: params.rev,
    since: params.since
  }), onOlderRevision = useTimelineSelector(timelineStore, (state2) => state2.onOlderRevision), revTime = useTimelineSelector(timelineStore, (state2) => state2.revTime), sinceAttributes = useTimelineSelector(timelineStore, (state2) => state2.sinceAttributes), timelineDisplayed = useTimelineSelector(timelineStore, (state2) => state2.timelineDisplayed), timelineReady = useTimelineSelector(timelineStore, (state2) => state2.timelineReady), isPristine = useTimelineSelector(timelineStore, (state2) => state2.isPristine), isDeleted = (0, import_react.useMemo)(() => timelineReady ? !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published) && !isPristine : false, [editState == null ? void 0 : editState.draft, editState == null ? void 0 : editState.published, isPristine, timelineReady]), previewUrl = usePreviewUrl(value), [presence, setPresence] = (0, import_react.useState)([]);
  (0, import_react.useEffect)(() => {
  ...
  ), ready = connectionState === "connected" && editState.ready && (!params.rev || timelineReady || !!timelineError), displayed = (0, import_react.useMemo)(
  ...
  const handleChange = (0, import_react.useCallback)((event) => patchRef.current(event), []), closeInspector = (0, import_react.useCallback)(
    (closeInspectorName) => {
      ...
      if (currentInspector) {
        if (inspector) {
          const result = ((_a2 = inspector.onClose) == null ? void 0 : _a2.call(inspector, { params })) ?? { params };
          setInspectorName(null), inspectParamRef.current = void 0, setPaneParams({ ...result.params, inspect: void 0 });
          return;
        }
        if (currentInspector) {
          const result = ((_b = currentInspector.onClose) == null ? void 0 : _b.call(currentInspector, { params })) ?? { params };
          setInspectorName(null), inspectParamRef.current = void 0, setPaneParams({ ...result.params, inspect: void 0 });
        }
      }
    },
    ...
    (nextInspectorName, paneParams) => {
      ...
      currentInspector && (currentParams = (((_a2 = nextInspector.onClose) == null ? void 0 : _a2.call(nextInspector, { params: currentParams })) ?? {
        params: currentParams
      }).params);
      const result = ((_b = nextInspector.onOpen) == null ? void 0 : _b.call(nextInspector, { params: currentParams })) ?? { params: currentParams };
  ...
  ), telemetry = useTelemetry(), handleMenuAction = (0, import_react.useCallback)(
    (item) => {
    ...
    []
  ), requiredPermission = value._createdAt ? "update" : "create", liveEdit = !!(schemaType == null ? void 0 : schemaType.liveEdit), docId = value._id ? value._id : "dummy-id", docPermissionsInput = (0, import_react.useMemo)(() => ({
    ...value,
    _id: liveEdit ? getPublishedId(docId) : getDraftId(docId)
  }), [liveEdit, value, docId]), [permissions, isPermissionsLoading] = useDocumentValuePermissions({
    document: docPermissionsInput,
    permission: requiredPermission
  }), isNonExistent = !(value == null ? void 0 : value._id), readOnly = (0, import_react.useMemo)(() => {
    var _a2;
    ...
    return !ready || revTime !== null || hasNoPermission || updateActionDisabled || createActionDisabled || reconnecting || isLocked || isDeleting || isDeleted || isLiveEditAndDraft;
  }, [
    isPermissionsLoading,
    permissions == null ? void 0 : permissions.granted,
    schemaType,
    isNonExistent,
    connectionState,
    (_a = editState.transactionSyncLock) == null ? void 0 : _a.enabled,
    editState.draft,
    liveEdit,
    ready,
    revTime,
  ...
  const setOpenPath = (0, import_react.useCallback)(
    ...
    (_nextFocusPath, payload) => {
      const nextFocusPath = pathFor(_nextFocusPath);
      nextFocusPath !== focusPathRef.current && (setFocusPath(pathFor(nextFocusPath)), setOpenPath(pathFor(nextFocusPath.slice(0, -1))), focusPathRef.current = nextFocusPath, onFocusPath == null ? void 0 : onFocusPath(nextFocusPath)), updatePresenceThrottled(nextFocusPath, payload);
    },
  ...
  return (0, import_react.useEffect)(() => {
    ...
    if (ready && params.path) {
      const { path, ...restParams } = params, pathFromUrl = resolveKeyedPath((_a2 = formStateRef.current) == null ? void 0 : _a2.value, fromString(path));
...
var DocumentPane = (0, import_react.memo)(function(props) {
  ...
  return (0, import_jsx_runtime.jsx)(SourceProvider, { name: props.pane.source || parentSourceName, children: (0, import_jsx_runtime.jsx)(CopyPasteProvider, { children: (0, import_jsx_runtime.jsx)(DocumentPaneInner, { ...props }) }) });
});
...
function usePaneOptions(options, params = {}) {
  ...
  return (0, import_react.useMemo)(() => {
    ...
    if (options.type && options.type !== "*")
      return options;
    const templateName = options.template || params.template, documentType = (_a = templateName ? templates.find((t) => t.id === templateName) : void 0) == null ? void 0 : _a.schemaType;
...
function DocumentListPaneContent(props) {
  const {
    ...
    searchInputElement,
    showIcons
  } = props, schema = useSchema(), { collapsed: layoutCollapsed } = usePaneLayout(), { collapsed, index } = usePane(), [shouldRender, setShouldRender] = (0, import_react.useState)(!collapsed), { t } = useTranslation2(structureLocaleNamespace), handleEndReached = (0, import_react.useCallback)(() => {
  ...
  const renderItem = (0, import_react.useCallback)(
    ...
    return (0, import_jsx_runtime.jsx)(RootBox, { overflow: "hidden", height: "fill", $opacity: loadingVariant === "subtle" ? 0.8 : 1, children: (0, import_jsx_runtime.jsx)(CommandListBox, { children: (0, import_jsx_runtime.jsx)(
      CommandList,
      {
        activeItemDataAttr: "data-hovered",
        ariaLabel: paneTitle,
...
function listenSearchQuery(options) {
  const {
    ...
    share()
  ), [welcome$, mutationAndReconnect$] = partition(events$, (ev) => ev.type === "welcome"), swrKey = JSON.stringify({ filter: filter2, limit, params, searchQuery, sort, staticTypeNames });
  return merge(
    welcome$.pipe(take(1)),
...
function useDocumentList(opts) {
  const { filter: searchFilter, params: paramsProp, sortOrder, searchQuery, apiVersion } = opts, client = useClient({
    ...DEFAULT_STUDIO_CLIENT_OPTIONS,
    apiVersion: apiVersion || DEFAULT_STUDIO_CLIENT_OPTIONS.apiVersion
  }), { enableLegacySearch = false } = useWorkspace().search, schema = useSchema(), maxFieldDepth = useSearchMaxFieldDepth(), typeNameFromFilter = (0, import_react.useMemo)(
    () => findStaticTypesInFilter(searchFilter, paramsProp),
    [searchFilter, paramsProp]
  ), [onRetry$, onRetry] = (0, import_react.useMemo)(() => observableCallback(), []), [onFetchFullList$, onLoadFullList] = (0, import_react.useMemo)(() => observableCallback(), []), queryResults$ = (0, import_react.useMemo)(() => {
    const listenSearchQueryArgs = {
      ...
      maxFieldDepth,
      enableLegacySearch
    }, partialList$ = listenSearchQuery(listenSearchQueryArgs).pipe(
      shareReplay({ refCount: true, bufferSize: 1 })
    ...
    return merge(
      ...
      catchError((err, caught$) => concat(
        of({ type: "error", error: safeError(err) }),
    ...
    onFetchFullList$,
    onRetry$
  ]), { error, items, isLoading, fromCache, isLoadingFullList } = useObservable(
    queryResults$,
    INITIAL_QUERY_STATE
  );
  return {
...
var DocumentListPane = (0, import_react.memo)(function(props) {
  const { childItemId, isActive, pane: pane2, paneKey, sortOrder: sortOrderRaw, layout } = props, schema = useSchema(), { displayOptions, options } = pane2, { apiVersion, filter: filter2 } = options, params = useShallowUnique(options.params || EMPTY_RECORD), typeName = (0, import_react.useMemo)(() => {
  ...
  }, [filter2, params]), showIcons = (displayOptions == null ? void 0 : displayOptions.showIcons) !== false, { t } = useTranslation2(structureLocaleNamespace), { title } = useI18nText(pane2), [searchQuery, setSearchQuery] = (0, import_react.useState)(""), [searchInputValue, setSearchInputValue] = (0, import_react.useState)(""), [searchInputElement, setSearchInputElement] = (0, import_react.useState)(null), sortWithOrderingFn = typeName && sortOrderRaw ? applyOrderingFunctions(sortOrderRaw, schema.get(typeName)) : sortOrderRaw, sortOrder = useUnique(sortWithOrderingFn), { error, isLoadingFullList, isLoading, items, fromCache, onLoadFullList, onRetry } = useDocumentList({
    apiVersion,
    filter: filter2,
    params,
    ...
    [handleClearSearch]
  ), [enableSearchSpinner, setEnableSearchSpinner] = (0, import_react.useState)();
  (0, import_react.useEffect)(() => {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)(Box, { paddingX: 3, paddingBottom: 3, children: (0, import_jsx_runtime.jsx)(
      TextInput,
      {
        ...
        fontSize: [2, 2, 1],
        icon: textInputIcon,
        iconRight: loadingVariant === "subtle" && !searchInputValue ? DelayedSubtleSpinnerIcon : null,
...
function DocumentSheetListProvider({
  ...
  const [selectedAnchorCellDetails, setSelectedAnchorCellDetails] = (0, import_react.useState)(null), [selectedRangeCellIndexes, setSelectedRangeCellIndexes] = (0, import_react.useState)([]), clearAndSetFocusSelection = (0, import_react.useCallback)(
    ...
    (event) => {
      ...
      )) == null ? void 0 : _a.contains(event.target)) || resetFocusSelection());
    },
...
function SheetListCell(cell) {
  ...
  return (0, import_jsx_runtime.jsx)(
    Cell,
    {
      ...
      children: flexRender(cell.column.columnDef.cell, (_a = cell.getContext) == null ? void 0 : _a.call(cell))
    },
...
function ColumnsControl({ table }) {
  ...
  return (0, import_jsx_runtime.jsx)(
    MenuButton,
    {
      button: (0, import_jsx_runtime.jsx)(Button2, { mode: "bleed", text: t("sheet-list.edit-columns") }),
      id: "columns-control",
...
var PaneContainer = (0, import_react.memo)(function(props) {
  const { index, isSelected, pane: pane2, paneKey } = props, { name: parentSourceName } = useSource(), {
    ...
    initialValueTemplates = EMPTY_ARRAY$y,
    menuItemGroups,
    menuItems,
    options
  } = pane2, { defaultOrdering = EMPTY_ARRAY$y, filter: filter2 } = options, params = useShallowUnique(options.params || EMPTY_RECORD), sourceName = pane2.source, typeName = (0, import_react.useMemo)(() => {
    const staticTypes = findStaticTypesInFilter(filter2, params);
    return (staticTypes == null ? void 0 : staticTypes.length) === 1 ? staticTypes[0] : null;
...
var FormViewBuilder = class _FormViewBuilder extends GenericViewBuilder {
  constructor(spec) {
    ...
    __publicField(this, "spec");
    this.spec = { id: "editor", title: "Editor", ...spec || {} };
  }
  /**
...
var DocumentListBuilder = class _DocumentListBuilder extends GenericListBuilder {
  constructor(_context, spec) {
    ...
    __publicField(this, "spec");
    this._context = _context, this.spec = spec || {}, this.initialValueTemplatesSpecified = !!(spec == null ? void 0 : spec.initialValueTemplates);
  }
  /** Set API version
...
var ListBuilder = class _ListBuilder extends GenericListBuilder {
  constructor(_context, spec) {
    ...
    __publicField(this, "spec");
    this._context = _context, this.spec = spec || {}, this.initialValueTemplatesSpecified = !!(spec && spec.initialValueTemplates);
  }
  /**
    ...
    tools: [
      {
        ...
        icon,
        component: (0, import_react.lazy)(() => import("./index3-7FGCNTX7.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-CTBYD3JH.js.map
