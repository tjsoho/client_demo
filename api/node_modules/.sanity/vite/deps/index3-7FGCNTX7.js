import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-CTBYD3JH.js";
import "./chunk-GSUAJWOP.js";
import {
  Button,
  ErrorBoundary,
  NEVER,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-57LJ3QYO.js")),
  document: (0, import_react.lazy)(() => import("./pane-6WR7GXOH.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-6WR7GXOH.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-7HW2IUBQ.js"))
};
...
var StructureTool = (0, import_react.memo)(function({ onPaneChange }) {
  ...
  }, [pushToast]), ((_a = schema._original) == null ? void 0 : _a.types.some(_isCustomDocumentTypeDefinition)) ? (0, import_jsx_runtime.jsxs)(PortalProvider, { element: portalElement || null, children: [
...
//# sourceMappingURL=index3-7FGCNTX7.js.map
