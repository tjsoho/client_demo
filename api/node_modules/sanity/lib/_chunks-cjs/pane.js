...
var jsxRuntime = require("react/jsx-runtime"), ui = require("@sanity/ui"), React = require("react"), _singletons = require("sanity/_singletons"), icons = require("@sanity/icons"), camelCase = require("lodash/camelCase.js"), speakingurl = require("speakingurl"), uniqueId = require("lodash/uniqueId.js"), reactIs = require("react-is"), sanity = require("sanity"), uniq = require("lodash/uniq.js"), kebabCase = require("lodash/kebabCase.js"), generateHelpUrl_esm = require("./generate-help-url.esm.js"), find = require("lodash/find.js"), startCase = require("lodash/startCase.js"), uuid = require("@sanity/uuid"), styledComponents = require("styled-components"), omit = require("lodash/omit.js"), router$1 = require("sanity/router"), PathUtils = require("@sanity/util/paths"), rxjs = require("rxjs"), operators = require("rxjs/operators"), isHotkeyEsm = require("is-hotkey-esm"), reactI18next = require("react-i18next"), JSONInspector = require("@rexxars/react-json-inspector"), QuickLRU = require("quick-lru"), react = require("@sanity/telemetry/react"), reactRx = require("react-rx"), telemetry = require("@sanity/telemetry"), dateFns = require("date-fns"), types = require("@sanity/types"), framerMotion = require("framer-motion"), _internal = require("@sanity/schema/_internal"), throttle = require("lodash/throttle.js"), deepCompare = require("react-fast-compare"), isEqual = require("lodash/isEqual.js"), shallowEquals = require("shallow-equals"), CopyToClipboard = require("react-copy-to-clipboard"), isNumber = require("lodash/isNumber.js"), isString = require("lodash/isString.js"), uniqBy = require("lodash/uniqBy.js"), negate = require("lodash/negate.js"), groqJs = require("groq-js"), observableCallback = require("observable-callback"), rxjsExhaustmapWithTrailing = require("rxjs-exhaustmap-with-trailing"), reactTable = require("@tanstack/react-table");
...
function ReferencePreviewLink(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(sanity.PreviewCard, { __unstable_focusRing: !0, as: Link, "data-as": "a", onClick, radius: 2, children: /* @__PURE__ */ jsxRuntime.jsx(
    PaneItemPreview,
    {
      ...
      icon: type?.icon,
      layout: "compact",
      presence: documentPresence?.length > 0 ? documentPresence : EMPTY_ARRAY$1,
      schemaType: type,
      value
    }
  ) });
...
function ConfirmDeleteDialog({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    TooltipDelayGroupProvider.Dialog,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(DialogBody$1, { children: crossDatasetReferences && internalReferences && !isLoading ? /* @__PURE__ */ jsxRuntime.jsx(
...
function ConfirmDeleteDialogContainer(props) {
  ...
  ) : /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.ErrorBoundary, { onCatch: setError, children: /* @__PURE__ */ jsxRuntime.jsx(ConfirmDeleteDialog, { ...props }) });
}
function Delay({
  children,
  ms = 0
...
function useDocumentTitle() {
  const { connectionState, schemaType, title, editState } = useDocumentPane(), documentValue = editState?.draft || editState?.published, subscribed = !!documentValue, { error, value } = sanity.unstable_useValuePreview({
    enabled: subscribed,
    schemaType,
    value: documentValue
  });
  return connectionState === "connecting" && !subscribed ? { error: void 0, title: void 0 } : title ? { error: void 0, title } : documentValue ? error ? { error: `Error: ${error.message}`, title: void 0 } : { error: void 0, title: value?.title } : { error: void 0, title: `New ${schemaType?.title || schemaType?.name}` };
}
...
}), isLiveEditEnabled = (schemaType) => schemaType.liveEdit === !0, Root$5 = styledComponents.styled(ui.Card)({
  position: "relative",
  zIndex: 1,
  lineHeight: 0
});
...
function useStructureToolSetting(namespace, key, defaultValue) {
  const keyValueStore = sanity.useKeyValueStore(), keyValueStoreKey = [STRUCTURE_TOOL_NAMESPACE, namespace, key].filter(Boolean).join("."), value$ = React.useMemo(() => keyValueStore.getKey(keyValueStoreKey), [keyValueStore, keyValueStoreKey]), value = reactRx.useObservable(value$, defaultValue), set = React.useCallback(
    (newValue) => {
...
const VIEW_MODE_PARSED = { id: "parsed", title: "document-inspector.view-mode.parsed" }, VIEW_MODE_RAW = { id: "raw", title: "document-inspector.view-mode.raw-json" }, VIEW_MODES = [VIEW_MODE_PARSED, VIEW_MODE_RAW], lru = new QuickLRU__default.default({ maxSize: 1e3 });
...
function Banner(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { borderBottom: !0, paddingX: 4, paddingY: 2, tone, ...rest, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 3, children: [
    ...
    action && /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { ...action, mode: action.mode || "ghost", tone: action.tone || "default" })
  ] }) });
}
...
function RequestPermissionDialog({
  ...
  const { t } = sanity.useTranslation(structureLocaleNamespace), telemtry = react.useTelemetry(), dialogId = `request-permissions-${React.useId()}`, projectId = sanity.useProjectId(), client = sanity.useClient({ apiVersion: "2024-09-26" }), toast = ui.useToast(), zOffset = sanity.useZIndex(), [isSubmitting, setIsSubmitting] = React.useState(!1), [note, setNote] = React.useState(""), [msgError, setMsgError] = React.useState(), [hasTooManyRequests, setHasTooManyRequests] = React.useState(!1), [hasBeenDenied, setHasBeenDenied] = React.useState(!1), requestedRole$ = React.useMemo(() => {
    const adminRole = "administrator";
    return !projectId || !client ? rxjs.of(adminRole) : client.observable.request({ url: `/projects/${projectId}/roles` }).pipe(
      rxjs.map((roles) => roles.filter((role) => role?.appliesToUsers).find((role) => role.name === "editor") ? "editor" : adminRole),
      rxjs.startWith(adminRole),
      rxjs.catchError(() => rxjs.of(adminRole))
    );
  }, [projectId, client]), requestedRole = reactRx.useObservable(requestedRole$), onSubmit = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ui.DialogProvider, { position: "fixed", zOffset: zOffset.fullscreen, children: /* @__PURE__ */ jsxRuntime.jsx(
    TooltipDelayGroupProvider.Dialog,
    {
      width: 1,
      id: dialogId,
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(DialogBody, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Stack, { space: 4, children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: t("request-permission-dialog.description.text") }),
        hasTooManyRequests || hasBeenDenied ? /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { tone: "caution", padding: 3, radius: 2, shadow: 1, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { size: 1, children: [
...
const LOADING_STATE = { loading: !0, error: !1, status: void 0 }, EMPTY_STATE = { loading: !1, error: !1, status: "none" }, DECLINED_STATE = { loading: !1, error: !1, status: "declined" }, PENDING_STATE = { loading: !1, error: !1, status: "pending" }, EXPIRED_STATE = { loading: !1, error: !1, status: "expired" }, useRoleRequestsStatus = () => {
  const client = sanity.useClient({ apiVersion: "2024-07-01" }), projectId = sanity.useProjectId(), checkRoleRequests$ = React.useMemo(() => !client || !projectId ? rxjs.of(EMPTY_STATE) : checkRoleRequests(client, projectId), [client, projectId]), { loading, error, status } = reactRx.useObservable(checkRoleRequests$, LOADING_STATE);
...
function checkRoleRequests(client, projectId) {
  return client.observable.request({
    ...
    operators.map((requests) => {
      ...
      return declinedRequest && dateFns.isAfter(dateFns.addWeeks(new Date(declinedRequest.createdAt), 2), /* @__PURE__ */ new Date()) ? DECLINED_STATE : projectRequests.find(
        (request) => request.status === "pending" && dateFns.isAfter(dateFns.addWeeks(new Date(request.createdAt), 2), /* @__PURE__ */ new Date())
      ) ? PENDING_STATE : projectRequests.find(
        (request) => request.status === "pending" && dateFns.isBefore(dateFns.addWeeks(new Date(request.createdAt), 2), /* @__PURE__ */ new Date())
      ) ? EXPIRED_STATE : EMPTY_STATE;
    }),
    operators.catchError((err) => (console.error("Failed to fetch access requests", err), rxjs.of({ loading: !1, error: !0, status: void 0 }))),
...
function InsufficientPermissionBanner({
  ...
  } = useRoleRequestsStatus(), [requestSent, setRequestSent] = React.useState(!1), requestPending = React.useMemo(
    () => roleRequestStatus === "pending" || roleRequestStatus === "declined" || requestSent,
    [roleRequestStatus, requestSent]
  ), currentUserRoles = currentUser?.roles || [], isOnlyViewer = currentUserRoles.length === 1 && currentUserRoles[0].name === "viewer", [showRequestPermissionDialog, setShowRequestPermissionDialog] = React.useState(!1), listFormat = sanity.useListFormat({ style: "short" }), { t } = sanity.useTranslation(structureLocaleNamespace), telemetry2 = react.useTelemetry(), roleTitles = currentUserRoles.map((role) => role.title), roles = listFormat.formatToParts(roleTitles).map(
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    showRequestPermissionDialog && /* @__PURE__ */ jsxRuntime.jsx(
...
function DraftLiveEditBanner({
  ...
  const { t } = sanity.useTranslation(structureLocaleNamespace), [isPublishing, setPublishing] = React.useState(!1), [isDiscarding, setDiscarding] = React.useState(!1), telemetry2 = react.useTelemetry(), { publish, discardChanges } = sanity.useDocumentOperation(documentId, displayed?._type || ""), handlePublish = React.useCallback(() => {
    publish.execute(), setPublishing(!0), telemetry2.log(ResolvedLiveEdit, { liveEditResolveType: "publish" });
  }, [publish, telemetry2]), handleDiscard = React.useCallback(() => {
    discardChanges.execute(), setDiscarding(!0), telemetry2.log(ResolvedLiveEdit, { liveEditResolveType: "discard" });
  }, [discardChanges, telemetry2]);
  return React.useEffect(() => () => {
    setPublishing(!1), setDiscarding(!1);
  }), displayed && displayed._id && !sanity.isDraftId(displayed._id) ? null : /* @__PURE__ */ jsxRuntime.jsx(
    Banner,
    {
      content: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", justify: "space-between", gap: 1, children: [
...
const preventDefault = (ev) => ev.preventDefault(), FormView = React.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Container,
    {
      ...
      sizing: "border",
      width: 1,
      children: /* @__PURE__ */ jsxRuntime.jsx(sanity.PresenceOverlay, { margins, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { as: "form", onSubmit: preventDefault, ref: setRef, children: connectionState === "connecting" && !editState?.draft && !editState?.published ? /* @__PURE__ */ jsxRuntime.jsx(Delay, { ms: 300, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          sanity.FormBuilder,
          {
            ...
            openPath,
            presence,
            readOnly: connectionState === "reconnecting" || formState.readOnly || !editState?.ready,
      ...
      ui.PortalProvider,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: documentScrollElement, children: /* @__PURE__ */ jsxRuntime.jsxs(
          sanity.VirtualizerScrollInstanceProvider,
          {
            ...
            children: [
              activeView.type === "form" && isLiveEdit && ready && /* @__PURE__ */ jsxRuntime.jsx(
                DraftLiveEditBanner,
                {
                  displayed,
                  documentId,
              ...
              activeView.type === "form" && !isPermissionsLoading && ready && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                !permissions?.granted && /* @__PURE__ */ jsxRuntime.jsx(InsufficientPermissionBanner, { requiredPermission }),
...
function DocumentHeaderTab(props) {
  const { icon, id, isActive, label, tabPanelId, viewId, ...rest } = props, { ready, editState } = useDocumentPane(), { setView } = usePaneRouter(), handleClick = React.useCallback(() => setView(viewId), [setView, viewId]);
  return /* @__PURE__ */ jsxRuntime.jsx(
    TooltipDelayGroupProvider.Tab,
    {
      ...rest,
...
function DocumentHeaderTitle() {
  ...
  return connectionState === "connecting" && !subscribed ? /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {}) : title ? /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: title }) : documentValue ? error ? /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: t("panes.document-header-title.error.text", { error: error.message }) }) : /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: value?.title || /* @__PURE__ */ jsxRuntime.jsx("span", { style: { color: "var(--card-muted-fg-color)" }, children: t("panes.document-header-title.untitled.text") }) }) : /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: t("panes.document-header-title.new.text", {
...
function DocumentLayout() {
  ...
  return schemaType ? /* @__PURE__ */ jsxRuntime.jsxs(sanity.GetFormValueProvider, { value, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(sanity.FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY, children: /* @__PURE__ */ jsxRuntime.jsxs(
...
const DocumentPaneProvider = React.memo((props) => {
  ...
  ), ready = connectionState === "connected" && editState.ready && (!params.rev || timelineReady || !!timelineError), displayed = React.useMemo(
  ...
  const handleChange = React.useCallback((event) => patchRef.current(event), []), closeInspector = React.useCallback(
    ...
    const hasNoPermission = !isPermissionsLoading && !permissions?.granted, updateActionDisabled = !_internal.isActionEnabled(schemaType, "update"), createActionDisabled = isNonExistent && !_internal.isActionEnabled(schemaType, "create"), reconnecting = connectionState === "reconnecting", isLocked = editState.transactionSyncLock?.enabled, isLiveEditAndDraft = !!(liveEdit && editState.draft);
  ...
  const setOpenPath = React.useCallback(
    ...
    (_nextFocusPath, payload) => {
      const nextFocusPath = PathUtils.pathFor(_nextFocusPath);
      nextFocusPath !== focusPathRef.current && (setFocusPath(PathUtils.pathFor(nextFocusPath)), setOpenPath(PathUtils.pathFor(nextFocusPath.slice(0, -1))), focusPathRef.current = nextFocusPath, onFocusPath?.(nextFocusPath)), updatePresenceThrottled(nextFocusPath, payload);
    },
...
function DocumentListPaneContent(props) {
  const {
    ...
    searchInputElement,
    showIcons
  } = props, schema = sanity.useSchema(), { collapsed: layoutCollapsed } = usePaneLayout(), { collapsed, index } = usePane(), [shouldRender, setShouldRender] = React.useState(!collapsed), { t } = sanity.useTranslation(structureLocaleNamespace), handleEndReached = React.useCallback(() => {
  ...
  const renderItem = React.useCallback(
    ...
    if (error)
      return /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Container, { width: 1, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Stack, { paddingX: 4, paddingY: 5, space: 4, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(sanity.ErrorActions, { error, eventId: null, onRetry })
      ] }) }) });
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(RootBox, { overflow: "hidden", height: "fill", $opacity: loadingVariant === "subtle" ? 0.8 : 1, children: /* @__PURE__ */ jsxRuntime.jsx(CommandListBox, { children: /* @__PURE__ */ jsxRuntime.jsx(
      sanity.CommandList,
      {
        activeItemDataAttr: "data-hovered",
        ariaLabel: paneTitle,
...
const swr = sanity.createSWR({ maxSize: 100 });
function listenSearchQuery(options) {
  const {
    ...
    rxjs.share()
  ), [welcome$, mutationAndReconnect$] = rxjs.partition(events$, (ev) => ev.type === "welcome"), swrKey = JSON.stringify({ filter, limit, params, searchQuery, sort, staticTypeNames });
  return rxjs.merge(
    ...
    swr(swrKey),
    rxjs.map(({ fromCache, value }) => ({ fromCache, documents: value }))
  );
}
...
function useDocumentList(opts) {
  const { filter: searchFilter, params: paramsProp, sortOrder, searchQuery, apiVersion } = opts, client = sanity.useClient({
    ...sanity.DEFAULT_STUDIO_CLIENT_OPTIONS,
    apiVersion: apiVersion || sanity.DEFAULT_STUDIO_CLIENT_OPTIONS.apiVersion
  }), { enableLegacySearch = !1 } = sanity.useWorkspace().search, schema = sanity.useSchema(), maxFieldDepth = sanity.useSearchMaxFieldDepth(), typeNameFromFilter = React.useMemo(
    () => findStaticTypesInFilter(searchFilter, paramsProp),
    [searchFilter, paramsProp]
  ), [onRetry$, onRetry] = React.useMemo(() => observableCallback.observableCallback(), []), [onFetchFullList$, onLoadFullList] = React.useMemo(() => observableCallback.observableCallback(), []), queryResults$ = React.useMemo(() => {
    ...
    return rxjs.merge(
      ...
      operators.catchError((err, caught$) => rxjs.concat(
        rxjs.of({ type: "error", error: safeError(err) }),
    ...
    onFetchFullList$,
    onRetry$
  ]), { error, items, isLoading, fromCache, isLoadingFullList } = reactRx.useObservable(
    queryResults$,
    INITIAL_QUERY_STATE
  );
  return {
...
`, DocumentListPane = React.memo(function(props) {
  const { childItemId, isActive, pane: pane2, paneKey, sortOrder: sortOrderRaw, layout } = props, schema = sanity.useSchema(), { displayOptions, options } = pane2, { apiVersion, filter } = options, params = useShallowUnique(options.params || EMPTY_RECORD), typeName = React.useMemo(() => {
    ...
    [handleClearSearch]
  ), [enableSearchSpinner, setEnableSearchSpinner] = React.useState();
  React.useEffect(() => {
...
function ValidationCard(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(TooltipDelayGroupProvider.ErrorBoundary, { onCatch: setErrorInfo, children: [
