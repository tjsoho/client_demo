...
var rxjs = require("rxjs"), decode = require("./_chunks-cjs/decode.cjs"), mendoza = require("mendoza"), nanoid = require("nanoid"), utils = require("./_chunks-cjs/utils.cjs"), diffMatchPatch = require("@sanity/diff-match-patch"), getAtPath = require("./_chunks-cjs/getAtPath.cjs"), stringify = require("./_chunks-cjs/stringify.cjs");
